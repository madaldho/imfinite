...
const items = [
  ...
  },
  {
    ...
    prompt:
      "Ragdoll cat king wearing a golden crown, intricate, elegant, highly detailed",
  },
  {
    id: 3,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center justify-center">
            ...
            <div className=" order-1 md:order-2">
              <div className="w-full aspect-square relative animate-squeeze-slow">
                <img
                  src="https://i.postimg.cc/sfWKhYmR/Ai-2.png"
                  alt="ai"
            ...
            <div className="flate" key={i.id}>
              ...
              >
                <div className="flex items-center space-x-3">
                  <svg
                    className="h-6 w-6 group-hover:stroke-black/40"
                    viewBox="0 0 24 24"
                  >
                    <title>magnify</title>
                    <path d="M9.5,3A6.5,6.5 0 0,1 16,9.5C16,11.11 15.41,12.59 14.44,13.73L14.71,14H15.5L20.5,19L19,20.5L14,15.5V14.71L13.73,14.44C12.59,15.41 11.11,16 9.5,16A6.5,6.5 0 0,1 3,9.5A6.5,6.5 0 0,1 9.5,3M9.5,5C7,5 5,7 5,9.5C5,12 7,14 9.5,14C12,14 14,12 14,9.5C14,7 12,5 9.5,5Z" />
                  </svg>
                  <p className="text-xs font-semibold text-slate-900 group-hover:text-black/80 md:text-sm">
                    {i.title}
                  </p>
                </div>
              </button>
        ...
        <div className="container mx-auto px-5 pb-20 mt-20">
          <div className="fitur grid justify-center gap-14 p-3 grid-cols-1 md:grid-cols-3">
            <div
              ...
              className="card rounded-2xl border-2 border-fuchsia-700 p-5 shadow-md shadow-black w-full "
            >
              <img
                src="https://i.postimg.cc/cLBxL78z/search.png"
                className="card-img-top w-16"
                alt="search"
              />
              <div className="card-body">
                <h5 className="font-size20 font-bold">
                  Search Your Imagination
                </h5>
                <p className="card-text font-size16 font-medium">
                  Find an imaginary image of the text that you enter directly.
                </p>
              </div>
            </div>
            <div
              ...
              data-aos="fade-up"
              data-aos-duration="3000"
              className="card rounded-2xl border-2 border-fuchsia-700 p-5 shadow-md shadow-black/70 w-full"
            >
              <img
                src="https://i.postimg.cc/6pS1vqGN/galery-1.png"
                className="card-img-top w-16"
                alt="search"
              />
              <div className="card-body">
                ...
                <p className="card-text font-size16 font-medium">
                  All images are directly generated by AI with stunning results.
                </p>
              </div>
            </div>
            <div
            ...
            >
              <img
                src="https://i.postimg.cc/nLBT9kJv/icon-download-1.png"
                className="card-img-top w-16"
                alt="search"
              />
              <div className="card-body">
                ...
                <p className="card-text font-size16 font-medium">
                  Very easy to download after the image has been completed.
                </p>
              </div>
            </div>
          </div>
